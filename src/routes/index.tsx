...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "Seed — Smart Trading & Portfolio Tracker",
      },
      {
        property: "og:description",
        content:
          "A focused dashboard for tracking stocks, watchlists and portfolio performance.",
      },
    ],
  }),
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-5 py-12 md:grid-cols-2 md:py-16">
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-3 max-w-lg text-[15px] leading-relaxed text-muted-foreground">
              Seed brings real-time prices, watchlists, profit and loss, and
              allocation insights into one clean workspace. No noise, no
              clutter.
            </p>
            ...
            <div className="flex items-center justify-between border-b border-border pb-3">
              <div>
                ...
                <div className="num mt-1 text-2xl font-semibold">
                  {currency(curve[curve.length - 1].value)}
                </div>
              </div>
              <Delta
                value={
        ...
        <div className="mx-auto max-w-6xl px-5 py-12">
          <div className="mb-8 max-w-2xl">
            ...
            <p className="mt-1.5 text-sm text-muted-foreground">
              The essentials that traders and long-term investors actually use,
              without the bloat.
            </p>
          </div>
      ...
      <section id="analytics" className="border-b border-border bg-card">
        <div className="mx-auto grid max-w-6xl gap-8 px-5 py-12 md:grid-cols-5">
          <div className="md:col-span-2">
            ...
            <p className="mt-1.5 text-sm text-muted-foreground">
              Track returns over time, daily P/L, and benchmark performance
              against major indices. Visualizations stay clean and informative.
            </p>
        ...
        <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-6 px-5 py-8 sm:flex-row sm:items-center">
          <div>
            ...
            <p className="mt-2 max-w-xs text-xs text-muted-foreground">
              Seed is a portfolio tracking tool. Data shown is for demonstration
